               ...
               <div class="w3-container padding_none w3-center">
                  <div class="w3-container modal_half zona_agrega_marca">
                     <label class="w3-left-align" style="font-weight: bold;">
                        Agrega el nombre de la marca del
                        <span class="nombre_modelo_modal">
                        </span>
                     </label>
                     <input class="my_input txt_marca" placeholder="Escribir..." type="text"/>
                     <img alt="" class="img_check display_inine imagen_alerta" src="./img/done_outline-24px.svg" style="padding: 10px;border-radius: 50px;"/>
                  </div>
               </div>
            </div>
