<div class="w3-modal modal_inserta_marca">
  <div class="w3-container">
    <div class="w3-modal-content w3-animate-top w3-card-4 w3-padding-32 w3-round-xxlarge">
      <header class="w3-container">
        ...
        <div class="w3-container w3-card-4 w3-padding-16 contenedor_mensaje" style="display: none;">
          <p class="w3-center mensaje">
          </p>
          <button class="w3-btn w3-block w3-green btn_aceptar_mensaje" style="width:50%; margin: 10px auto;">
            Agregar
          </button>
        </div>
      </header>
      <div class="w3-container padding_none">
        <div class="w3-row w3-section padding_none">
          <div class="w3-container padding_none w3-center">
            <div class="w3-container modal_half zona_agrega_marca">
