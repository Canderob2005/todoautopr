...
if (!empty($_POST)) {
   //  Real scape en PDO
   // https://exceptionshub.com/what-is-the-pdo-equivalent-of-function-mysql_real_escape_string-2.html
					...
					<div class="panel-body" >
						...
						<form id="signupform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'];?>" method="POST" autocomplete="off">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" class="form-control" name="nombre" placeholder="Nombre" value="<?php if (isset($nombre)) {
   echo $nombre;
}
?>" required >
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" class="form-control" name="usuario" placeholder="Usuario" value="<?php if (isset($usuario)) {
   echo $usuario;
}
?>" required>
								</div>
