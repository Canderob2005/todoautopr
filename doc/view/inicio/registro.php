<html>
   <head>
      ...
      <link href="Registro_files/bootstrap.css" rel="stylesheet"/>
      <link href="Registro_files/bootstrap-theme.css" rel="stylesheet"/>
            ...
            <div class="panel panel-info carta">
               <div class="panel-heading">
                  ...
                  <div style="float:right; font-size: 85%; position: relative; top:-10px">
                     <a href="inicio.php" id="signinlink">
                        Iniciar Sesión
                     </a>
                  </div>
               </div>
               <div class="panel-body">
                  <form action="server/registro/registro.php" autocomplete="off" class="form-horizontal" id="signupform" method="POST" role="form">
